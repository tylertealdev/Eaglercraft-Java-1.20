...
pig_option_photo = extract_png_asset('options/pig_option')
athlete_steve_option_photo = extract_png_asset('options/athlete_steve_option')
athlete_alex_option_photo = extract_png_asset('options/athlete_alex_option')
developer_steve_option_photo = extract_png_asset('options/developer_steve_option')
developer_alex_option_photo = extract_png_asset('options/developer_alex_option')
prisoner_steve_option_photo = extract_png_asset('options/prisoner_steve_option')
prisoner_alex_option_photo = extract_png_asset('options/prisoner_alex_option')
tennis_steve_option_photo = extract_png_asset('options/tennis_steve_option')
tennis_alex_option_photo = extract_png_asset('options/tennis_alex_option')
tuxedo_steve_option_photo = extract_png_asset('options/tuxedo_steve_option')
tuxedo_alex_option_photo = extract_png_asset('options/tuxedo_alex_option')
slime_option_photo = extract_png_asset('options/slime_option')
scottish_steve_option_photo = extract_png_asset('options/scottish_steve_option')
scottish_alex_option_photo = extract_png_asset('options/scottish_alex_option')
barney_option_photo = extract_png_asset('options/barney_option')
boxer_steve_option_photo = extract_png_asset('options/boxer_steve_option')
